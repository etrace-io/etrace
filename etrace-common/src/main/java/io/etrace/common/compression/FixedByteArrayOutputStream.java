...
public class FixedByteArrayOutputStream extends OutputStream {
     ...
     * @throws OutOfMemoryError if {@code minCapacity < 0}.  This is interpreted as a request for the unsatisfiably
     *                          large capacity {@code (long) Integer.MAX_VALUE + (minCapacity - Integer.MAX_VALUE)}.
     */
     ...
     * output in the output stream is discarded. The output stream can be used again, reusing the already allocated
     * buffer space.
     *
     ...
     * sequences with the default replacement string for the platform's default character set. The {@linkplain
    ...
    /**
     * Creates a newly allocated string. Its size is the current size of the output stream and the valid contents of the
     * buffer have been copied into it. Each character <i>c</i> in the resulting string is constructed from the
     * corresponding element <i>b</i> in the byte array such that:
     * <blockquote><pre>
     ...
     * @deprecated This method does not properly convert bytes into characters. As of JDK&nbsp;1.1, the preferred way to
     * do this is via the
     * <code>toString(String enc)</code> method, which takes an encoding-name
     * argument, or the <code>toString()</code> method, which uses the platform's default character encoding.
     */
    @Deprecated
