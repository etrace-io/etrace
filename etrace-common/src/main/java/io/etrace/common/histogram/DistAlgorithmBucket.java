...
import io.etrace.common.exception.InvalideDisctributionTypeException;
...
public class DistAlgorithmBucket {
    ...
    public static BucketFunction buildBucketFunction(DistributionType distributionType, long baseNumber) {
        switch (distributionType) {
            ...
            default:
                throw new InvalideDisctributionTypeException("Unknown distribution type :" + distributionType);
        }
    }
}
