...
/**
 * HBASE Table有三个"名字"： 1. logicalName: 如trace/metric等，与TableSchema.getLogicalTableName()的名字一致。 2. tableNamePrefix:
 * 可通过pipeline配置的物理表名前缀。其与logicalName有一一对应的关系。 3. physicalTableName: 根据数据的timestamp生成的具体物理表名，以tableNamePrefix为前缀。
 */
