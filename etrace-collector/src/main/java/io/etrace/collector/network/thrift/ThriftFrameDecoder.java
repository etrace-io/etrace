...
import static io.etrace.collector.metrics.MetricName.UNFRAMED_MESSAGE;
...
public class ThriftFrameDecoder extends ByteToMessageDecoder {
    ...
    private Counter unframedMessageCounter;

    public ThriftFrameDecoder(int maxFrameSize, TProtocolFactory inputProtocolFactory) {
        this.maxFrameSize = maxFrameSize;
        this.inputProtocolFactory = inputProtocolFactory;
        this.unframedMessageCounter = Metrics.counter(UNFRAMED_MESSAGE,
            Tags.of("host", NetworkInterfaceHelper.INSTANCE.getLocalHostName()));
    }
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf buffer, List<Object> out) throws Exception {
        ...
        if (firstByte >= 0x80) {
            ...
            unframedMessageCounter.increment();
